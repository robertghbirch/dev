...
{
  static Tutorial__Person__PhoneNumber init_value = TUTORIAL__PERSON__PHONE_NUMBER__INIT;
  *message = init_value;
}
void   tutorial__person__init
                     (Tutorial__Person         *message)
{
  static Tutorial__Person init_value = TUTORIAL__PERSON__INIT;
  *message = init_value;
}
...
{
  static Tutorial__AddressBook init_value = TUTORIAL__ADDRESS_BOOK__INIT;
  *message = init_value;
}
